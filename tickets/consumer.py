...
from tickets.background.telegram_bots.activate_webhook import send_message_to_client
...
class LiveScoreConsumer(WebsocketConsumer):
    ...
    def get_messages(self, data):
        ...
        message_to_output.filter(id__in=ids_messages_to_output, sender="client", sending_state="delivered")
